...
def main():
    ...
    baseURL = input("Enter the base URL of your ArchivesSpace installation (default is 'http://localhost:8089'): ")
    write_value("baseURL", "http://localhost:8089", baseURL)
    repoId = input("Enter the repository ID for your ArchivesSpace installation (default is '2'): ")
    write_value("repository", "2", repoId)
    username = input("Enter the username for your ArchivesSpace installation (default is 'admin'): ")
    write_value("user", "admin", username)
    password = input("Enter the password associated with this username (default is 'admin'): ")
    ...
    directory = input("Enter the directory in which you want to save the spreadsheet (default is the current directory): ")
    write_value("directory", "", directory)
    filename = input("Now tell me the filename of the CSV spreadsheet you want to create (default is 'dacs_singlelevel_report.csv'): ")
